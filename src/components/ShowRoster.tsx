              ...
              >
                <CardContent className="py-4">
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Popularity:{" "}
                    <span className="font-semibold text-slate-900">{manga.popularity}%</span>
                  </p>
                </CardContent>
              </Card>
            ))
        ...
        <DialogContent className="max-w-md sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription className="space-y-1">
              <p>
                Popularity:{" "}
                <span className="font-medium text-slate-950">{detailManga?.popularity}%</span>
              </p>
              <p>
                Concept:{" "}
                <span className="font-medium text-slate-950">
                  {detailManga ? detailManga.conceptType : ""}
                </span>
              </p>
            </DialogDescription>
          </DialogHeader>
            ...
            <div>
              ...
              <div className="space-y-1">
                {detailManga?.synopsis.map((line, index) => (
                  <p
                    key={`${detailManga.id}-synopsis-${index}`}
